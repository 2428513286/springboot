	...
	<div style="height: 5%">
		<form name="searchform" method="post" id ="searchform">
			...
			性别：<select name="qsex" id="qsex"  class="easyui-combobox">
		        ...
		        <a  id="upload" name="upload" class="easyui-linkbutton" data-options="iconCls:'icon-ok'" >导入</a>
		        
		        
		        <a  id="export_btn" name="download" class="easyui-linkbutton" data-options="iconCls:'icon-ok'">导出</a>
	  	</form>
  	</div>
  	<div style="height: 95%">
		...
		<form id="ff" method="post">
			<table style="margin: 0 auto;">
				...
				<!-- <tr>
					...
					<td><input id="Classes" class="easyui-combobox" name="cid"> </td>
				</tr> -->
